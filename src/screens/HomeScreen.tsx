        ...
        <View style={{ width: ANCHO }}>
          ...
          >
            ...
            {[
              ...
              { onPress: () => navigation.navigate('Respiracion'), icono: '🫁', titulo: t.respiracionTitulo || 'Respiración', desc: t.respiracionSub || 'Ejercicios de respiración guiados', grad: ['#06B6D4', '#0891B2'] as [string, string] },
